        ...
        <div class="card">
          ...
          <div class="card-body"  style="text-align: center;">
            <span class='zoom' id='ex1'>
              <img class="zoom-img" src="{{ asset('images/productimage/'.$data->product_image) }}"  width='600' height='320' alt="SHOW IMAGE HERE" style="max-width:325px">
            </span>
          </div>
                      ...
                      <div class="panel panel-default arrow left">
                        <div class="panel-body">
                          <header class="text-left">
                            ...
                            <time class="comment-date" datetime="16-12-2014 01:05"><i class="fa fa-clock-o"></i>{{ date('d-m-y',strtotime($rating->created_at)) }}
